...
public class FontManager {
    ...
    static public HashMap< String, String > enumerateFonts()
    {
        ...
        String[] fontdirs = new String[1];
        fontdirs[0] = Environment.getExternalStorageDirectory().getPath() + "/fonts";
        Log.d("TEST", fontdirs[0]);
        ...
        for ( String fontdir : fontdirs )
        {
            ...
            for ( File file : files )
            {
                ...
                //if (fontname != null)
                	//Log.d("TEST", fontname + " " + file.getAbsolutePath());                
            }
        }
